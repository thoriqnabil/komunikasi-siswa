                ...
                <div class="card">
                    ...
                    <form action="/insertdata4" method="POST" enctype="multipart/form-data">
                        ...
                        <label for="exampleInputEmail1" class="form-label">Siswa</label>
                            <select class="form-control" name="dasis_id" id="" required>
                        ...
                        <label for="exampleInputEmail1" class="form-label">Pelanggaran</label>
                            <select class="form-control" name="pelanggaran_id" id="" required>
                            <option disabled hidden>Pilih Pelanggaran</option>
                            @foreach ($dataa as $data_pelanggaran)
                            <option value="{{ $data_pelanggaran->id }}">{{ $data_pelanggaran->namapelanggaran }}</option>
                            @endforeach
                            </select>
                        </div>
