...
<html lang="en">
  <head>
    ...
    <title>Point Pelanggaran - Tambah Data Siswa</title>
  </head>
  <body>
                ...
                <div class="card">
                    ...
                    <form action="/insertdata" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama" class="form-control" placeholder="Nama Lengkap" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="nisn" placeholder="NISN" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="alamat" placeholder="Alamat" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">No Telepon</label>
                            <input type="number" class="form-control" name="notelp" placeholder="No Telepon" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
